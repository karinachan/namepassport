...
function validateForm() {
  var x = document.getElementById("interestdropdown").value;
  if (x == "blank") {
    alert("Please select an interest"); // prompt user
    document.getElementById("interestdropdown").focus(); //set focus back to control
    return false;
